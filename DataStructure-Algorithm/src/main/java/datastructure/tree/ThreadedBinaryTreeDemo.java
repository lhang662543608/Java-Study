...
public class ThreadedBinaryTreeDemo {
    public static void main(String[] args) {
        ...
        PersonNode node6 = new PersonNode(14, "dim");
        ...
        //测试: 以10号节点测试
        PersonNode leftNode = node5.getLeft();
        PersonNode rightNode = node5.getRight();
...
class PersonNode {
    private int no;
    private String name;
    private PersonNode left; //默认null
    private PersonNode right; //默认null
    //说明
