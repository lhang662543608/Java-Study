...
public class JDBCTest {
    ...
    public void testNamedParameterJdbcTemplate2(){
        String sql = "INSERT INTO employees(name, email, dept_id) "
    ...
    public void testNamedParameterJdbcTemplate(){
        String sql = "INSERT INTO employees(name, email, dept_id) VALUES(:ln,:email,:deptid)";
    ...
    public void testQueryForObject(){
        String sql = "SELECT id,  name, email, dept_id as \"department.id\" FROM employees WHERE id = ?";
        RowMapper<Employee> rowMapper = new BeanPropertyRowMapper<>(Employee.class);
